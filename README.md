...
The project we have developed aims to facilitate the rehabilitation of patients with Amyotrophic Lateral Sclerosis (ALS) through an exergame, i.e., a video game based on physical movement. The idea is based on several important aspects:
