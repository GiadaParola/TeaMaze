...
def main():
    ...
    img_scheletro = carica_immagine(os.path.join(IMG_DIR, "scheletroOro.png"), (100, 100, 100))  # Immagine scheletro
    ...
    nemico_che_ha_colpito = None  # Quale nemico ha colpito (1, 2 o 3)
    ...
    while True:
        ...
        # --- INIZIALIZZA ---
            ...
            if(livello_scelto==livelli_possibili[0]):
                ...
                nemico2 = nemico.Nemico(300, 500, img_ghost, grid_info)
                nemico2.start_pos = (300, 500)
                nemico2.tipo = "GHOST"
                nemico3 = None
            elif(livello_scelto==livelli_possibili[1]):
                # Livello 2: Ghost + Scheletro
                pos_iniziale_giocatore = (110, 390)
                player = giocatore.Giocatore(110, 390, img_m_statica, frames_animati)
                nemico1 = nemico.Nemico(450, 300, img_ghost, grid_info)
                nemico1.start_pos = (450, 300)
                nemico1.tipo = "GHOST"
                nemico2 = nemico.Nemico(200, 500, img_scheletro, grid_info)
                nemico2.start_pos = (200, 500)
                nemico2.tipo = "SCHELETRO"
                nemico3 = None
            else:
        ...
        # --- IN GIOCO ---
            ...
            if nemico2 and player.rect.colliderect(nemico2.rect):
                ...
                mostra_feedback = False
                stato_gioco = "DOMANDA_RISPOSTA"
            if nemico3 and player.rect.colliderect(nemico3.rect):
                domanda_attiva = random.choice(DOMANDE)
                nemico_che_ha_colpito = 3
                risposta_selezionata = None
                mostra_feedback = False
                stato_gioco = "DOMANDA_RISPOSTA"
            ...
            if nemico3:
                nemico3.draw(v_screen, (cam_x, cam_y))  # Disegna nemico3
            ...
            if mostra_feedback:
                ...
                if timer_feedback == 89:  # Immediatamente dopo la selezione
                    if feedback_colore:  # Risposta giusta
                        ...
                        elif nemico_che_ha_colpito == 3:
                            nemico3.rect.topleft = (-1000, -1000)
                        ...
                        if nemico_che_ha_colpito == 1 and nemico1:
                            ...
                            if getattr(nemico2, 'tipo', '') == 'DRAGO':
                                ...
                                enemy_anim_frames = []
                            enemy_anim_owner = 2
                        elif nemico_che_ha_colpito == 3 and nemico3:
                            # Scheletro e Ghost non hanno animazioni speciali
                            enemy_anim_frames = []
                            enemy_anim_owner = 3
            ...
            if enemy_anim_timer > 0:
                ...
                if enemy_anim_frames:
                    ...
                    try:
                        ...
                        if enemy_anim_owner == 1 and nemico1:
                            ...
                            screen.blit(frame, (sx, sy))
                        elif enemy_anim_owner == 3 and nemico3:
                            sx = int((nemico3.rect.x - cam_x) * scale)
                            sy = int((nemico3.rect.y - cam_y) * scale)
                            screen.blit(frame, (sx, sy))
                    except Exception:
                        pass
                ...
                if enemy_anim_timer <= 0:
                    ...
                    if enemy_anim_owner == 2 and nemico2 and hasattr(nemico2, 'start_pos'):
                        ...
                        nemico2.path = []
                        nemico2.target = None
                    if enemy_anim_owner == 3 and nemico3 and hasattr(nemico3, 'start_pos'):
                        nemico3.rect.center = nemico3.start_pos
                        nemico3.path = []
                        nemico3.target = None
                    enemy_anim_owner = None
                    enemy_anim_frames = []
